...
export default function TableCards({querySearch, onTableClick }:any) {
    ...
    const tableData = [
      ...
      {"id": 10,"name": "Table 10","status": "Available","capacity": 6,},
      {"id": 11,"name": "Table 11","status": "Available","capacity":4,},
      {"id": 12,"name": "Table 12","status": "Available","capacity":2,},
      {"id": 13,"name": "Table 13","status": "Available","capacity":6,},
      {"id": 14,"name": "Table 14","status": "Available","capacity":7,},
  ]
